...
namespace HospitalAdvance.BusinessLogic
{
    ...
    public class BLDIS01
    {
		...
		/// </summary>
		/// <param name="objDIS01">Object of class DIS01</param>
		/// <returns>True if object is valid and false otherwise</returns>
        public bool validation(DIS01 objDIS01)
        {
        ...
        public List<DIS01> Select()
        {
            using (var db = _dbFactory.OpenDbConnection())
            {
                ...
                List<DIS01> lstDIS01 = db.Select<DIS01>();

                BLUSR01.CacheOperations("Dieases", lstDIS01);
        ...
        public string WriteData()
        {
            using (StreamWriter sw = new StreamWriter(path))
            {
                ...
                using (var db = _dbFactory.OpenDbConnection())
                {
                    sw.WriteLine("Dieases id, Dieases name, Doctor name");
