...
namespace HospitalAdvance.BusinessLogic
{
    ...
    public class BLTokenHandler
    {
        ...
        public static string GenerateToken(USR01 user)
        {
            ...
            cache.Set(CachePrefix + user.R01F02, tokenString, new CacheItemPolicy { AbsoluteExpiration = DateTime.UtcNow.AddMinutes(20) });
        ...
        public static string RefreshToken(USR01 user)
        {
