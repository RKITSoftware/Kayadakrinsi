...
namespace HospitalAdvance.BusinessLogic
{
    ...
    public class BLUSR01
    {
        ...
        /// </summary>
        private readonly BLSTF01 _objBLDoctor;

        /// <summary>
        /// Declares object of class BLHelper
        /// </summary>
        private readonly BLSTF02 _objBLHelper;

        /// <summary>
        /// Declares object of class BLPatient
        /// </summary>
        private readonly BLPTN01 _objBLPatient;
        ...
        public BLUSR01()
        {
            ...
            _objBLDoctor = new BLSTF01();
            _objBLHelper = new BLSTF02();
            _objBLPatient = new BLPTN01();
            _objDL = new DL();
        }
