...
namespace HospitalAPI
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.OperationFilter<BasicAuthOperationFilter>(); // Register the filter
    ...
    public class BasicAuthOperationFilter : IOperationFilter
    {
        ...
        
        {
            ...
            else if (apiDescription.ActionDescriptor.ControllerDescriptor.ControllerType.FullName.Contains("V2"))
            {
                // Check if the method has the BasicAuth attribute
                var basicAuthRequired = apiDescription.GetControllerAndActionAttributes<JWTAuthentication>().Any();
